...
import user.profile.service.PurchaseService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link user.profile.service.impl.PurchaseServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PurchaseServiceBaseImpl extends BaseServiceImpl
	implements PurchaseService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link user.profile.service.PurchaseServiceUtil} to access the purchase remote service.
	 */
	 ...
	 */
	public user.profile.service.UserProfileService getUserProfileService() {
	...
	public void setUserProfileService(
		user.profile.service.UserProfileService userProfileService) {
	...
	@BeanReference(type = PurchaseService.class)
	...
	@BeanReference(type = user.profile.service.UserProfileService.class)
	protected user.profile.service.UserProfileService userProfileService;
