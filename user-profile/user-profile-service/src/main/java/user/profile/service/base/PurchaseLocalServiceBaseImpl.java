...
package user.profile.service.base;
...
import user.profile.service.PurchaseLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link user.profile.service.impl.PurchaseLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class PurchaseLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements PurchaseLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link user.profile.service.PurchaseLocalServiceUtil} to access the purchase local service.
	 */
	...
	public Purchase createPurchase(PurchasePK purchasePK) {
		return purchasePersistence.create(purchasePK);
	}
	...
	public Purchase deletePurchase(PurchasePK purchasePK)
		...
		return purchasePersistence.remove(purchasePK);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Purchase.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return purchasePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return purchasePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public Purchase fetchPurchase(PurchasePK purchasePK) {
		return purchasePersistence.fetchByPrimaryKey(purchasePK);
	}
	...
	public Purchase getPurchase(PurchasePK purchasePK)
		throws PortalException {
		return purchasePersistence.findByPrimaryKey(purchasePK);
	}
	 ...
	 */
	public PurchaseLocalService getPurchaseLocalService() {
	 ...
	 */
	public user.profile.service.UserProfileLocalService getUserProfileLocalService() {
	...
	public void setUserProfileLocalService(
		user.profile.service.UserProfileLocalService userProfileLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("user.profile.model.Purchase",
			purchaseLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"user.profile.model.Purchase");
	}
	...
	@BeanReference(type = PurchaseLocalService.class)
