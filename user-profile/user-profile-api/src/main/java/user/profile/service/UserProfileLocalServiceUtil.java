 ...
 * {@link user.profile.service.impl.UserProfileLocalServiceImpl} and is the
 ...
 * @see user.profile.service.base.UserProfileLocalServiceBaseImpl
 * @see user.profile.service.impl.UserProfileLocalServiceImpl
 * @generated
 */
@ProviderType
public class UserProfileLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link user.profile.service.impl.UserProfileLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static java.util.List<user.profile.model.UserProfile> getUserProfiles(
		int start, int end) {
	...
	*/
	public static user.profile.model.UserProfile addUserProfile(
	...
	*/
	public static user.profile.model.UserProfile createUserProfile(
		java.lang.String userId) {
		return getService().createUserProfile(userId);
	}
	...
	*/
	public static user.profile.model.UserProfile deleteUserProfile(
		java.lang.String userId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteUserProfile(userId);
	}
	...
	*/
	...
	public static user.profile.model.UserProfile fetchUserProfile(
		java.lang.String userId) {
		return getService().fetchUserProfile(userId);
	}
	...
	* @throws PortalException if a user profile with the primary key could not be found
	*/
	public static user.profile.model.UserProfile getUserProfile(
		java.lang.String userId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static user.profile.model.UserProfile updateUserProfile(
		user.profile.model.UserProfile userProfile) {
